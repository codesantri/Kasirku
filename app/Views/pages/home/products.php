        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-sm">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="font-weight-bold bg-secondary">
                    ...
                    <?= csrf_field() ?>
                    <?= inputText(type: 'hidden', name: 'invoice', value: $invoice) ?>
                    <?= inputText(type: 'hidden', name: 'total', value: $total) ?>
                    <?= inputRadio(
                        '',
                        'Metode Pembayaran',
                        [
                    ...
                    <hr>
                    <?= inputTextIdr(label: 'Total Belanja', name: 'total', id: 'total', value: esc($total), attributes: ['readonly' => 'readonly']) ?>
                    <?= inputTextIdr(label: 'Nominal Pembayaran', name: 'cash', id: 'cash', value: 0, attributes: ['required' => 'required']) ?>
                    <?= inputTextIdr(label: 'Nominal Kembalian', name: 'change', id: 'change', value: 0, attributes: ['readonly' => 'readonly']) ?>
